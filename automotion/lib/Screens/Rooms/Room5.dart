...
class Room5 extends StatefulWidget{
  ...
  State<StatefulWidget> createState() {
    ...
    return new Room5State();
  }

}
class Room5State extends State<Room5> {
    ...
    if (swNum==9){
      ...
      setState(() {
        if (value) {
          ...
          sendSignal("5", swNum.toString(), "on");
          if (++numOn==8){
            switchNum[8]=true;
          }
          ...
          sendSignal("5", swNum.toString(), "off");
          if (--numOn<8){
            switchNum[8]=false;
          }
...
//      _onChildRemoved=roomSwitch.onChildRemoved.listen(_onChildRemovedFunction);
    ...
    setInitialDataFromPreferences("room5Sw");
    setInitialDataFromPreferences("room5Icons");
...
//        print(e.snapshot.value);
      ...
      setState(() {
        ...
        roomSwitch=FirebaseDatabase.instance.reference().child("Licenses")
            .child(myLicence).child("Rooms").child("Room5");
  ...
  editAll(){
    if (!canEdit){
      ...
      setState(() {
        ...
        saveData("room5Sw",switchesTexts);
        saveData("room5Icons",lampStatus);
      });
    }
  }
          ...
          child:  new Column(
            ...
            children: <Widget>[
              new ClipRRect(
                ...
                child: Image.asset(
                  "assets/images/bathroom1.png",fit: BoxFit.cover,scale: 1,
                ),
              ),
              new Flexible(child:
