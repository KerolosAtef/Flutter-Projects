...
class Room7 extends StatefulWidget{
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return new Room7State();
  }

}
class Room7State extends State<Room7> {
    ...
    if (swNum==9){
      ...
      setState(() {
        if (value) {
          ...
          sendSignal("7", swNum.toString(), "on");
          if (++numOn==8){
            switchNum[8]=true;
          }
          ...
          sendSignal("7", swNum.toString(), "off");
          if (--numOn<8){
            switchNum[8]=false;
          }
...
//      _onChildRemoved=roomSwitch.onChildRemoved.listen(_onChildRemovedFunction);
    ...
    setInitialDataFromPreferences("room7Sw");
    setInitialDataFromPreferences("room7Icons");
...
//        print(e.snapshot.value);
      ...
      setState(() {
        ...
        roomSwitch=FirebaseDatabase.instance.reference().child("Licenses")
            .child(myLicence).child("Rooms").child("Room7");
  ...
  editAll(){
    if (!canEdit){
      ...
      setState(() {
        ...
        saveData("room7Sw",switchesTexts);
        saveData("room7Icons",lampStatus);
      });
    }
  }
          ...
          child:  new Column(
            children: <Widget>[
              new ClipRRect(
                ...
                child: Image.asset(
                  "assets/images/bedroom4.png",fit: BoxFit.cover,scale: 1,
                ),
              ),
              new Flexible(child:
