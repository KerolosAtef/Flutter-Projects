...
class Room8 extends StatefulWidget{
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return new Room8State();
  }

}
class Room8State extends State<Room8> {
    ...
    if (swNum==9){
      ...
      setState(() {
        if (value) {
          ...
          sendSignal("8", swNum.toString(), "on");
          if (++numOn==8){
            switchNum[8]=true;
          }
          ...
          sendSignal("8", swNum.toString(), "off");
          if (--numOn<8){
            switchNum[8]=false;
          }
  ...
  void initState() {
    ...
    setInitialDataFromPreferences("room8Sw");
    setInitialDataFromPreferences("room8Icons");
...
//        print(e.snapshot.value);
      ...
      setState(() {
        ...
        roomSwitch=FirebaseDatabase.instance.reference().child("Licenses")
            .child(myLicence).child("Rooms").child("Room8");
  ...
  editAll(){
    if (!canEdit){
      ...
      setState(() {
        ...
        saveData("room8Sw",switchesTexts);
        saveData("room8Icons",lampStatus);
      });
    }
  }
          ...
          child:  new Column(
            children: <Widget>[
              new ClipRRect(
                ...
                child: Image.asset(
                  "assets/images/bathroom2.png",fit: BoxFit.cover,scale: 1,
                ),
              ),
              new Flexible(child:
