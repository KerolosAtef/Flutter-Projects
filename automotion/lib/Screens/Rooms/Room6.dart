...
class Room6 extends StatefulWidget{
  ...
  State<StatefulWidget> createState() {
    ...
    return new Room6State();
  }

}
class Room6State extends State<Room6> {
    ...
    if (swNum==9){
      ...
      setState(() {
        if (value) {
          ...
          sendSignal("6", swNum.toString(), "on");
          if (++numOn==8){
            switchNum[8]=true;
          }
          ...
          sendSignal("6", swNum.toString(), "off");
          if (--numOn<8){
            switchNum[8]=false;
          }
...
//      _onChildRemoved=roomSwitch.onChildRemoved.listen(_onChildRemovedFunction);
    ...
    setInitialDataFromPreferences("room6Sw");
    setInitialDataFromPreferences("room6Icons");
...
//        print(e.snapshot.value);
      ...
      setState(() {
        ...
        roomSwitch=FirebaseDatabase.instance.reference().child("Licenses")
            .child(myLicence).child("Rooms").child("Room6");
  ...
  editAll(){
    if (!canEdit){
      ...
      setState(() {
        ...
        saveData("room6Sw",switchesTexts);
        saveData("room6Icons",lampStatus);
      });
    }
  }
          ...
          child:  new Column(
            children: <Widget>[
              new ClipRRect(
                ...
                child: Image.asset(
                  "assets/images/bedroom3.png",fit: BoxFit.cover,scale: 1,
                ),
              ),
              new Flexible(child:
